...
こんな感じで数式を書くことができる。もちろんインラインの $\LaTeX$ も使える。ついでに絵文字も使える:smile:
...
<video controls playsinline width="80%" autoplay loop muted="true" src="images/1.mp4" type="video/mp4" >
